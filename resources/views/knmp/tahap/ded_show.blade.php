    ...
    <div class="col-12">
        <div class="page-title-box">
            <div class="page-title-left">
                <h4 class="page-title"><i class="mdi mdi-drawing me-2"></i>Detail Tahap DED</h4>
            ...
            <div class="page-title-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('ded.index') }}">DED</a></li>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header" style="background: linear-gradient(135deg, #10b981, #059669); border: none;">
                <h5 class="card-title mb-0 text-white"><i class="mdi mdi-drawing me-2"></i>Data Tahap DED</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('ded.store', $knmp->nama) }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_pengesahan" value="{{ $data->tanggal_pengesahan ?? '' }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-medium">File URL</label>
                        <input type="text" class="form-control" name="file_url" value="{{ $data->file_url ?? '' }}" placeholder="URL dokumen DED">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-medium">Catatan</label>
                        <textarea class="form-control" name="catatan" rows="4" placeholder="Catatan terkait DED...">{{ $data->catatan ?? '' }}</textarea>
                    </div>
                    <div class="text-end">
