<form method="POST" action="{{ route('forms.tanggapan_masyarakat.store') }}">
    @csrf
    ...
    <div class="mb-3">
        ...
        @endphp
        <div class="form-check">
            <input class="form-check-input" type="radio" name="senang" id="senang1" value="Senang" {{ $senang == 'Senang' ? 'checked' : '' }}>
            <label class="form-check-label" for="senang1">Senang</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="senang" id="senang2" value="Biasa saja" {{ $senang == 'Biasa saja' ? 'checked' : '' }}>
            <label class="form-check-label" for="senang2">Biasa saja</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="senang" id="senang3" value="Tidak Senang" {{ $senang == 'Tidak Senang' ? 'checked' : '' }}>
