                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h5 class="mb-0 fw-semibold">{{ $responden->filter(fn($r) => $r['is_complete'])->count() }} /
                                {{ count($responden) }}
                            </h5>
                        </div>
                    </div>
        ...
        <div class="row">
            @foreach($responden as $item)
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card border-0 shadow-sm h-100 responden-card-item" id="responden-{{ $item['id'] }}"
                        data-responden-id="{{ $item['id'] }}">
                        <div class="card-body">
                            <!-- Checkbox & Status -->
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input responden-check"
                                        value="{{ hashid($item['id']) }}" onchange="updateSelection()"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between py-2 border-bottom">
                                    ...
                                    <span
                                        class="fw-medium small">{{ \Carbon\Carbon::parse($item['tanggal_wawancara'])->format('d/m/Y') }}</span>
                                </div>
                                <div class="d-flex justify-content-between py-2 border-bottom">
                                ...
                                <div class="d-flex justify-content-between py-2">
                                    ...
                                    <span class="fw-medium small">
                                        <span
                                            class="badge bg-primary text-white">{{ $item['filled_forms'] }}/{{ $item['total_forms'] }}</span>
                                    </span>
                                </div>
                            </div>
