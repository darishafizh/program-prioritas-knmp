    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3"><label class="form-label">Langsung ke pasar/pembeli eceran (Kg/Trip)</label>
                <input type="number" name="pemasaran_eceran_kg" class="form-control" step="any" value="{{ old('pemasaran_eceran_kg') }}">
            </div>
            <div class="mb-3"><label class="form-label">Koperasi (Kg/Trip)</label>
                <input type="number" name="pemasaran_koperasi_kg" class="form-control" step="any" value="{{ old('pemasaran_koperasi_kg') }}">
            </div>
            <div class="mb-3"><label class="form-label">Tengkulak (Kg/Trip)</label>
                <input type="number" name="pemasaran_tengkulak_kg" class="form-control" step="any" value="{{ old('pemasaran_tengkulak_kg') }}">
            </div>
        </div>

        <div class="col-md-6">
            <div class="mb-3"><label class="form-label">Pengepul (Kg/Trip)</label>
                <input type="number" name="pemasaran_pengepul_kg" class="form-control" step="any" value="{{ old('pemasaran_pengepul_kg') }}">
            </div>
