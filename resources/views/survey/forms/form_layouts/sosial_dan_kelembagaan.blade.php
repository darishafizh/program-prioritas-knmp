<form method="POST" action="{{ route('forms.store_sosial_kelembagaan', ['knmp' => $knmp->id]) }}">
        ...
        <div class="mb-3">
                ...
                <div>
                        <div class="form-check form-check-inline"><input type="radio" name="anggota_kelompok"
                                        value="Ya, sangat aktif" class="form-check-input" id="akl_1" {{ old('anggota_kelompok') == 'Ya, sangat aktif' ? 'checked' : '' }}><label class="form-check-label"
                                        for="akl_1">Ya, sangat aktif</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="anggota_kelompok"
                                        value="Ya, tidak aktif" class="form-check-input" id="akl_2" {{ old('anggota_kelompok') == 'Ya, tidak aktif' ? 'checked' : '' }}><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="anggota_kelompok"
                                        value="Tidak ada kelompok nelayan/KUB di lokasi saya" class="form-check-input" id="akl_4" {{ old('anggota_kelompok') == 'Tidak ada kelompok nelayan/KUB di lokasi saya' ? 'checked' : '' }}><label
        ...
        <div class="mb-3">
                ...
                <div>
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_kelompok"
                                        value="Sangat Setuju" class="form-check-input" id="mkl_1" {{ old('manfaat_kelompok') == 'Sangat Setuju' ? 'checked' : '' }}><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_kelompok" value="Setuju"
                                        class="form-check-input" id="mkl_2" {{ old('manfaat_kelompok') == 'Setuju' ? 'checked' : '' }}><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_kelompok" value="Cukup Setuju"
                                        class="form-check-input" id="mkl_3" {{ old('manfaat_kelompok') == 'Cukup Setuju' ? 'checked' : '' }}><label class="form-check-label" for="mkl_3">Cukup
                                        Setuju</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_kelompok"
                                        value="Kurang Setuju" class="form-check-input" id="mkl_4" {{ old('manfaat_kelompok') == 'Kurang Setuju' ? 'checked' : '' }}><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_kelompok" value="Tidak Setuju"
                                        class="form-check-input" id="mkl_5" {{ old('manfaat_kelompok') == 'Tidak Setuju' ? 'checked' : '' }}><label class="form-check-label" for="mkl_5">Tidak
                                        Setuju</label></div>
                </div>
        </div>
        ...
        <div class="mb-3">
                ...
                <div>
                        <div class="form-check form-check-inline"><input type="radio" name="anggota_koperasi"
                                        value="Ya, sangat aktif" class="form-check-input" id="akp_1" {{ old('anggota_koperasi') == 'Ya, sangat aktif' ? 'checked' : '' }}><label class="form-check-label"
                                        for="akp_1">Ya, sangat aktif</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="anggota_koperasi"
                                        value="Ya, tidak aktif" class="form-check-input" id="akp_2" {{ old('anggota_koperasi') == 'Ya, tidak aktif' ? 'checked' : '' }}><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="anggota_koperasi"
                                        ...
                                        id="akp_4" {{ old('anggota_koperasi') == 'Tidak ada koperasi perikanan di lokasi saya' ? 'checked' : '' }}><label class="form-check-label" for="akp_4">Tidak ada koperasi perikanan di
        ...
        <div class="mb-3">
                ...
                <div>
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="tertarik_koperasi"
                                        value="Tidak tertarik" class="form-check-input" id="tkp_2" {{ old('tertarik_koperasi') == 'Tidak tertarik' ? 'checked' : '' }}><label class="form-check-label"
                                        for="tkp_2">Tidak tertarik</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="tertarik_koperasi"
                                        value="Tertarik" class="form-check-input" id="tkp_3" {{ old('tertarik_koperasi') == 'Tertarik' ? 'checked' : '' }}><label class="form-check-label"
        ...
        <div class="mb-3">
                ...
                <div>
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_koperasi"
                                        value="Sangat Setuju" class="form-check-input" id="mkp_1" {{ old('manfaat_koperasi') == 'Sangat Setuju' ? 'checked' : '' }}><label class="form-check-label"
                        ...
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_koperasi" value="Setuju"
                                        class="form-check-input" id="mkp_2" {{ old('manfaat_koperasi') == 'Setuju' ? 'checked' : '' }}><label class="form-check-label"
                                        for="mkp_2">Setuju</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_koperasi"
                                        value="Cukup Setuju" class="form-check-input" id="mkp_3" {{ old('manfaat_koperasi') == 'Cukup Setuju' ? 'checked' : '' }}><label class="form-check-label"
                                        for="mkp_3">Cukup Setuju</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_koperasi"
                                        value="Kurang Setuju" class="form-check-input" id="mkp_4" {{ old('manfaat_koperasi') == 'Kurang Setuju' ? 'checked' : '' }}><label class="form-check-label"
                                        for="mkp_4">Kurang Setuju</label></div>
                        <div class="form-check form-check-inline"><input type="radio" name="manfaat_koperasi"
                                        value="Tidak Setuju" class="form-check-input" id="mkp_5" {{ old('manfaat_koperasi') == 'Tidak Setuju' ? 'checked' : '' }}><label class="form-check-label"
