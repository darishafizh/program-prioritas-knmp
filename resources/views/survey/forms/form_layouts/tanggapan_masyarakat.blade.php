<form method="POST" action="{{ route('survey.forms.store_tanggapan_masyarakat', ['knmp' => $knmp->id]) }}">
    @csrf
    ...
    <div class="mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="kesesuaian_kebutuhan" id="yaSesuai"
                value="1" {{ old('kesesuaian_kebutuhan') == 1 ? 'checked' : '' }}>
            <label class="form-check-label" for="yaSesuai">Ya, sesuai</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="kesesuaian_kebutuhan" id="tidakSesuai"
                value="0" {{ old('kesesuaian_kebutuhan') === "0" ? 'checked' : '' }}>
    ...
    <div class="mb-3">
        ...
        <textarea id="inputTidakSesuai" name="item_tidak_sesuai" rows="3"
            class="form-control">{{ old('item_tidak_sesuai') }}</textarea>
    </div>
    ...
    <div class="mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="tingkat_kesenangan"
                id="senang" value="Senang" {{ old('tingkat_kesenangan') == 'Senang' ? 'checked' : '' }}>
            <label class="form-check-label" for="senang">Senang</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="tingkat_kesenangan"
                id="biasa" value="Biasa saja" {{ old('tingkat_kesenangan') == 'Biasa saja' ? 'checked' : '' }}>
            <label class="form-check-label" for="biasa">Biasa saja</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="tingkat_kesenangan"
                id="tidakSenang" value="Tidak Senang" {{ old('tingkat_kesenangan') == 'Tidak Senang' ? 'checked' : '' }}>
    ...
    <div class="mb-3">
        ...
        <textarea id="inputAlasan" name="alasan_tidak_senang" rows="3"
            class="form-control">{{ old('alasan_tidak_senang') }}</textarea>
    </div>
