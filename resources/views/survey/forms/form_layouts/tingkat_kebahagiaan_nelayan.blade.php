<form method="POST" action="{{ route('forms.store_tingkat_kebahagiaan', ['knmp' => $knmp->id]) }}">
    @csrf
        ...
        <select name="responden_id"
            ...
            @php
                $isSelected = old('responden_id') == $r->id || 
                             ...
                             (isset($selectedRespondenData['tingkat_kebahagiaan']) && $selectedRespondenData['tingkat_kebahagiaan'] && $selectedRespondenData['tingkat_kebahagiaan']->responden_id == $r->id && !old('responden_id'));
            @endphp
