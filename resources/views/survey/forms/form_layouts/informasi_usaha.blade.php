    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3"><label class="form-label">Dimensi Perahu (Panjang x Lebar x Dalam)</label>
                <input type="text" name="dimensi_perahu" class="form-control" placeholder="Contoh: 10 x 3 x 1.5" value="{{ old('dimensi_perahu') }}">
            </div>
        </div>
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline"><input type="radio" name="jenis_bahan_baku"
                            value="Fiber" class="form-check-input" id="bb_fiber" {{ old('jenis_bahan_baku') == 'Fiber' ? 'checked' : '' }}><label class="form-check-label"
                            for="bb_fiber">Fiber</label></div>
                    <div class="form-check form-check-inline"><input type="radio" name="jenis_bahan_baku"
                            value="Kayu" class="form-check-input" id="bb_kayu" {{ old('jenis_bahan_baku') == 'Kayu' ? 'checked' : '' }}><label class="form-check-label"
                            for="bb_kayu">Kayu</label></div>
                    <div class="form-check form-check-inline"><input type="radio" name="jenis_bahan_baku"
                            value="Besi" class="form-check-input" id="bb_besi" {{ old('jenis_bahan_baku') == 'Besi' ? 'checked' : '' }}><label class="form-check-label"
                            for="bb_besi">Besi</label></div>
                    <div class="form-check form-check-inline"><input type="radio" name="jenis_bahan_baku"
                            value="Kayu Laminasi" class="form-check-input" id="bb_kayulam" {{ old('jenis_bahan_baku') == 'Kayu Laminasi' ? 'checked' : '' }}><label
                            class="form-check-label" for="bb_kayulam">Kayu Laminasi</label></div>
                    <div class="form-check form-check-inline"><input type="radio" name="jenis_bahan_baku"
                            value="Lainnya" class="form-check-input" id="bb_lain" {{ old('jenis_bahan_baku') == 'Lainnya' ? 'checked' : '' }}><label class="form-check-label"
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline"><input type="radio" name="alat_penyimpanan"
                            value="Palka" class="form-check-input" id="ap_palka" {{ old('alat_penyimpanan') == 'Palka' ? 'checked' : '' }}><label class="form-check-label"
                    ...
                    <div class="form-check form-check-inline"><input type="radio" name="alat_penyimpanan"
                            value="Tong plastik" class="form-check-input" id="ap_tong" {{ old('alat_penyimpanan') == 'Tong plastik' ? 'checked' : '' }}><label
                            class="form-check-label" for="ap_tong">Tong plastik</label></div>
                    <div class="form-check form-check-inline"><input type="radio" name="alat_penyimpanan"
                            value="Lainnya" class="form-check-input" id="ap_lain" {{ old('alat_penyimpanan') == 'Lainnya' ? 'checked' : '' }}><label class="form-check-label"
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3"><label class="form-label">1. Jumlah hari per trip (hari/trip)</label>
                <input type="number" name="hari_per_trip" class="form-control" step="any" value="{{ old('hari_per_trip') }}">
            </div>
            <div class="mb-3"><label class="form-label">2. Lama waktu melaut setiap trip (jam/trip)</label>
                <input type="number" name="waktu_melaut_jam" class="form-control" step="any" value="{{ old('waktu_melaut_jam') }}">
            </div>
            <div class="mb-3"><label class="form-label">3. Jarak ke daerah penangkapan (mil)</label>
                <input type="number" name="jarak_penangkapan_mil" class="form-control" step="any" value="{{ old('jarak_penangkapan_mil') }}">
            </div>
            <div class="mb-3"><label class="form-label">4. Waktu tempuh ke daerah penangkapan (jam)</label>
                <input type="number" name="waktu_tempuh_jam" class="form-control" step="any" value="{{ old('waktu_tempuh_jam') }}">
            </div>
            <div class="mb-3"><label class="form-label">5. Jumlah trip/bulan (trip/bulan)</label>
                <input type="number" name="jml_trip_per_bulan" class="form-control" step="any" value="{{ old('jml_trip_per_bulan') }}">
            </div>
            <div class="mb-3"><label class="form-label">6. Jumlah bulan melaut (bulan/tahun)</label>
                <input type="number" name="jml_bulan_melaut" class="form-control" step="any" value="{{ old('jml_bulan_melaut') }}">
            </div>
            <div class="mb-3"><label class="form-label">7. Rata-rata Produksi Per Trip (Kg/Trip)</label>
                <input type="number" name="produksi_kg_per_trip" class="form-control" step="any" value="{{ old('produksi_kg_per_trip') }}">
            </div>
            <div class="mb-3"><label class="form-label">8. Rata-rata Penjualan Ikan Per Trip (Rp/Trip)</label>
                <input type="number" name="penjualan_rp_per_trip" class="form-control" step="any" value="{{ old('penjualan_rp_per_trip') }}">
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3"><label class="form-label">9. Biaya Solar Per Trip (Rp/Trip)</label>
                <input type="number" name="biaya_solar_rp" class="form-control" step="any" value="{{ old('biaya_solar_rp') }}">
            </div>
            <div class="mb-3"><label class="form-label">10. Volume Solar Per Trip (Liter/Trip)</label>
                <input type="number" name="volume_solar_liter" class="form-control" step="any" value="{{ old('volume_solar_liter') }}">
            </div>
            <div class="mb-3"><label class="form-label">11. Biaya Bensin Per Trip (Rp/Trip)</label>
                <input type="number" name="biaya_bensin_rp" class="form-control" step="any" value="{{ old('biaya_bensin_rp') }}">
            </div>
            <div class="mb-3"><label class="form-label">12. Volume Bensin Per Trip (Liter/Trip)</label>
                <input type="number" name="volume_bensin_liter" class="form-control" step="any" value="{{ old('volume_bensin_liter') }}">
            </div>
            <div class="mb-3"><label class="form-label">13. Biaya Es Balok dari Pabrik Per Trip (Rp/Trip)</label>
                <input type="number" name="biaya_es_balok_rp" class="form-control" step="any" value="{{ old('biaya_es_balok_rp') }}">
            </div>
            <div class="mb-3"><label class="form-label">14. Volume Es Balok dari Pabrik Per Trip
                    (Balok/Trip)</label>
                <input type="number" name="volume_es_balok" class="form-control" step="any" value="{{ old('volume_es_balok') }}">
            </div>
            <div class="mb-3"><label class="form-label">15. Biaya Es Kantong Per Trip (Rp/Trip)</label>
                <input type="number" name="biaya_es_kantong_rp" class="form-control" step="any" value="{{ old('biaya_es_kantong_rp') }}">
            </div>
            <div class="mb-3"><label class="form-label">16. Volume Es Kantong Per Trip (Kantong/Trip)</label>
                <input type="number" name="volume_es_kantong" class="form-control" step="any" value="{{ old('volume_es_kantong') }}">
            </div>
            <div class="mb-3"><label class="form-label">17. Total Biaya Operasional Tiap Melaut (Rp/Trip)</label>
                <input type="number" name="total_biaya_operasional" class="form-control" step="any" value="{{ old('total_biaya_operasional') }}">
            </div>
        </div>
    </div>
